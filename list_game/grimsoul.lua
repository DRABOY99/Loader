...
local ITEM_LIST_DATA = {
      ...
      ["8.0 item"] = {
        ["Battlepass23 Banner Infantryman"] = "battlepass23_banner_infantryman",
        ["Battlepass23 Banner Paladin"] = "battlepass23_banner_paladin",
        ["Battlepass23 Stamp Large"] = "battlepass23_stamp_large",
        ["Battlepass23 Stamp Middle"] = "battlepass23_stamp_middle",
        ["Battlepass23 Stamp Small"] = "battlepass23_stamp_small",
        ["Battlepass23 Stamp Tiny"] = "battlepass23_stamp_tiny",
        ["Chest Grim Soul8"] = "chest_grim_soul8",
        ["Fabric Thick"] = "fabric_thick",
        ["Hatchet Iron"] = "hatchet_iron",
        ["Inventory Gacha Boat"] = "inventory_gacha_boat",
        ["Inventory Gacha Weapon Blight"] = "inventory_gacha_weapon_blight",
        ["Paladin Boots"] = "paladin_boots",
        ["Paladin Gloves"] = "paladin_gloves",
        ["Paladin Hat"] = "paladin_hat",
        ["Paladin Pants"] = "paladin_pants",
        ["Paladin Shirt"] = "paladin_shirt",
        ["Pickaxe Iron"] = "pickaxe_iron",
        ["Research Boat 1"] = "research_boat_1",
        ["Research Boat 2"] = "research_boat_2",
        ["Research Boat 3"] = "research_boat_3",
        ["Research For Paladin Boots"] = "research_for_paladin_boots",
        ["Research For Paladin Gloves"] = "research_for_paladin_gloves",
        ["Research For Paladin Hat"] = "research_for_paladin_hat",
        ["Research For Paladin Pants"] = "research_for_paladin_pants",
        ["Research For Paladin Shirt"] = "research_for_paladin_shirt",
        ["Research Workbench Talisman 1"] = "research_workbench_talisman_1",
        ["Research Workbench Talisman 2"] = "research_workbench_talisman_2",
        ["Research Workbench Talisman 3"] = "research_workbench_talisman_3",
        ["Silver Ingot Magic"] = "silver_ingot_magic",
        ["Silver Ore Corrupted"] = "silver_ore_corrupted",
        ["Talisman Backup 3"] = "talisman_backup_3",
        ["Talisman Fake Any 1"] = "talisman_fake_any_1",
        ["Talisman Fake Any 2"] = "talisman_fake_any_2",
        ["Talisman Fake Any 3"] = "talisman_fake_any_3",
        ["Talisman Fake Any 4"] = "talisman_fake_any_4",
        ["Talisman Fake Merge Reward 2"] = "talisman_fake_merge_reward_2",
        ["Talisman Fake Merge Reward 3"] = "talisman_fake_merge_reward_3",
        ["Talisman Fake Merge Reward 4"] = "talisman_fake_merge_reward_4",
        ["Talisman Fake Rnd 1"] = "talisman_fake_rnd_1",
        ["Talisman Fake Rnd 2"] = "talisman_fake_rnd_2",
        ["Talisman Fake Rnd 3"] = "talisman_fake_rnd_3",
        ["Talisman Fake Rnd 4"] = "talisman_fake_rnd_4",
        ["Talisman Fake Same 1"] = "talisman_fake_same_1",
        ["Talisman Fake Same 2"] = "talisman_fake_same_2",
        ["Talisman Fake Same 3"] = "talisman_fake_same_3",
        ["Talisman Healing 2"] = "talisman_healing_2",
        ["Talisman Healing 3"] = "talisman_healing_3",
        ["Talisman Lifesteal Phys 3"] = "talisman_lifesteal_phys_3",
        ["Talisman Scare Ng 2"] = "talisman_scare_ng_2",
...
local function show_welcome()
 ...
 ✨ DRABOY GRIM SOUL TOOLS 
 📅 Version: 8.0.0 (64-bit)
 🛠️ Release: 11 February 2026
 ⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘

 📝 UPDATE LOG:
 ⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘
 🔸 🔥 Add new Item 8.0.0
 🔸 ⚠️ Use with u own risk !
 🔸 ⚠️ Don't add non-existent items in Game		
