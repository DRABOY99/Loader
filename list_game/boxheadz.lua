...
local CACHE_FILE = "/sdcard/boxhead_modular.lua"
...
registerFeature(
    ...
    "WeaponData",
    "get_DamageBaseBonus",
    {0x528D6500,0x72A9CDC0,0x1E270000,0xD65F03C0},
    "⚔",
    "Instant Kill",
    0
)
...
registerFeature(
    ...
    "PlayPersistentDataSO",
    "GetCurrency",
    {0x1286BFE0,0x72A77340,0xD65F03C0},
    "💰",
    "Max Resource",
    3
)
...
gg.clearResults()
gg.setVisible(false)
gg.toast("🚀 Loading Modular Draboy Engine")
